...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/courses/course.js":[function(require,module,exports) {
'use strict';
...
var DropDownList = /*#__PURE__*/function () {
  ...
  _createClass(DropDownList, [{
    key: "addEventListennerFilter",
    value: function addEventListennerFilter() {
    ...
    value: function addEventListenner() {
      var arrWithElem = [document.querySelector('.choose-course__choose-method'), document.querySelector('.choose-course__list-methods'), document.querySelector('.choose-course__list-img')];
      var dropDownElem = document.querySelector('.sort-menu');
      var degElem = document.querySelector('.choose-course__list-img');
      for (var _i = 0, _arrWithElem = arrWithElem; _i < _arrWithElem.length; _i++) {
        var elem = _arrWithElem[_i];
